    ...
    <div className="space-y-8">
      ...
      {allDone && (
        <motion.div
          ...
          className="max-w-md mx-auto text-center rounded-3xl bg-white dark:bg-slate-900 shadow-xl p-8"
        >
          <Trophy className="w-12 h-12 mx-auto text-amber-500 mb-3" />
          <p className="text-slate-700 dark:text-slate-200 font-semibold mb-5">
          ...
          <div className="flex gap-2 justify-center">
            ...
            <button
              onClick={resetSpin}
              className="inline-flex items-center gap-2 rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-700 dark:text-slate-200 font-semibold px-4 py-2.5 transition"
            >
      ...
      {presentedIds.length > 0 && !allDone && (
        <div className="text-center">
          ...
          <div className="flex flex-wrap gap-2 justify-center">
            ...
            <button
              onClick={resetSpin}
              className="rounded-full bg-slate-100 dark:bg-slate-800 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 px-3 py-1 text-xs font-semibold text-slate-600 dark:text-slate-300"
            >
              Reset all
            </button>
          </div>
